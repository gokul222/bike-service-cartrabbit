...
<div class="container login">
      ...
      <div class="card shadow p-5 animated zoomIn slow">
        ...
        <form id="data-insert"  data-parsley-validate action="javascript:void(0);" method="post" name="data-insert" class="">
          <div class="form-group">
            ...
            <input type="text" id="f_workshop_name" name="f_workshop_name" class="form-control">
          </div>
          <div class="form-group">
            <label>Enter Phoneno</label>
            <input type="text" id="f_workshop_phono" name="f_workshop_phono" class="form-control">
          </div>
          <div class="form-group">
            <label>Shop Description</label>
            <input type="text" id="f_workshop_desc" name="f_workshop_desc" class="form-control">
          </div>
          <div class="form-group">
            <label>Shop Discount</label>
            <input type="text" id="f_workshop_disc" name="f_workshop_disc" class="form-control">
          </div>
           <div class="form-group">
            <label>Shop Photo</label>
            <input type="file" id="f_workshop_photo" name="f_workshop_photo" class="form-control">
          </div>
          <div class="form-group">
            <label>Enter Email Address</label>
            <input type="text" id="f_workshop_email" name="f_workshop_email" class="form-control">
          </div>
          <div class="form-group">
            <label>Enter Password</label>
            <input type="password" id="f_workshop_password" 
            name="f_workshop_password" class="form-control">
          </div>
          <!-- <div class="form-group">
  ...
  $("form[name='data-check']").validate({
   ...
   $("form[name='data-insert']").validate({
    ...
    submitHandler: function(form) {
       var formDataa =new FormData(document.getElementById("data-insert"));
       $.ajax({
                    url: url + '/Vendor/vendorinsert',
                    type: 'post',
                    data: formDataa,
                    dataType: 'json',
                    cache: false,
